   ...
   include("data_class.php");
    ?>
           <div class="container">
            ...
            <p class="pColor"><u>Person Name:</u> &nbsp;&nbsp;<?php echo $name ?></p>
            <p class="pColor"><u>Person Email:</u> &nbsp;&nbsp;<?php echo $email ?></p>
            <p class="pColor"><u>Account Type:</u> &nbsp;&nbsp;<?php echo $type ?></p>
            ...
            <th class='otheruser'>Book Name</th><th class='otheruser'>Book Authour</th><th class='otheruser'>branch</th><th class='otheruser'>price</th></th><th class='otheruser'>Request Book</th></tr>";
